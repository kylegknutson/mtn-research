...
<!-- PROVENANCE_START -->
*The recommended route was distilled from **11 recorded GPS tracks** of real trips (14ers.com · ListsofJohn · Kyle's recordings) — all layered on the [interactive CalTopo research map](https://caltopo.com/m/9VGDUR3).*
<!-- PROVENANCE_END -->
*[Interactive CalTopo map](https://caltopo.com/m/9VGDUR3)* — source GPX tracks (14ers library) in green, with the **recommended composed loop in bold magenta**; 2 summit markers + the West Willow upper TH.
...
| **Recommended loop (composed)** | **~8.2 mi / ~3,050'** — real-GPS loop from the West Willow TH out to the pair and back (`build_recommended_route.py`); gain DEM-measured |
...
*The **recommended route (bold magenta)** — a ~8.2 mi / ~3,050' loop from the West Willow upper TH out to PT 13,166 and PT 13,308 and back, taken from real recorded GPS (gain DEM-measured). Pair it with the trio over two days: the **[West Willow La Garita 2-day trip](../trips/west_willow_la_garita.md)**.*
...
- **~8.2 mi / ~3,050'** recommended loop for the pair (DEM gain), Class 2 with a **Class 3** move on PT 13,166. Best done as the **[West Willow La Garita 2-day trip](../trips/west_willow_la_garita.md)** with the trio (or all five in one ~25 mi push).
