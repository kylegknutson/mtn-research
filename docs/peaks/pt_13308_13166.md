...
yds_class: "2"
gain: "~11.8 mi / ~4,200 ft (recommended loop, DEM) · Class 3 on 13,166"
status: unclimbed
caltopo_id: 9VGDUR3
...
| **Recommended loop (composed)** | **~11.8 mi / ~4,200'** — real-GPS loop from the West Willow TH out to the pair and back (`build_recommended_route.py`); gain DEM-measured |
...
*The **recommended route (bold magenta)** — a ~11.8 mi / ~4,200' loop from the West Willow upper TH out to PT 13,166 and PT 13,308 and back, taken from real recorded GPS (gain DEM-measured). Pair it with the trio over two days: the **[West Willow La Garita 2-day trip](../trips/west_willow_la_garita.md)**.*
...
- **~11.8 mi / ~4,200'** recommended loop for the pair (DEM gain), Class 2 with a **Class 3** move on PT 13,166. Best done as the **[West Willow La Garita 2-day trip](../trips/west_willow_la_garita.md)** with the trio (or all five in one ~25 mi push).
