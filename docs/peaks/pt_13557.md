...
days: 1
drive_h: 4.7
th_source: "recorded GPS-track start at Lily Lake / Huerfano TH (end of CO 580) (37.628,-105.473) — swept tracks begin at the TH"
class_source: "route beta — listsofjohn + peakbagger trip-report tracks (Class 2 standard NW approach; matches peak_db summit grade)"
...
!!! tip "At a glance — recommended day"
    **12.2 mi** · **5,544 ft** gain · **Class 2** · 1 peak · ~4.7 h drive
...
!!! weather ""
    **NOAA weather link:** [PT 13,557 Weather](https://forecast.weather.gov/MapClick.php?lat=37.61311&lon=-105.45581)

!!! map ""
    **CalTopo research map:** <https://caltopo.com/m/KQCQ1L6>
...
<!-- PROVENANCE_START -->
*Note: the recommended route was distilled from **13 recorded GPS tracks** of real trips (14ers.com · ListsofJohn · peakbagger · Kyle's recordings) — all layered on the [interactive CalTopo research map](https://caltopo.com/m/KQCQ1L6).*
<!-- PROVENANCE_END -->
...
| | [PT 13,557](https://www.14ers.com/peaks/10631) |
|---|---|
| Elevation | 13,557' |
...
## Getting there — Lily Lake TH (= Huerfano TH area)
