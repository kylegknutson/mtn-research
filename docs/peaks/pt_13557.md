...
<!-- PROVENANCE_START -->
*The recommended route was distilled from **13 recorded GPS tracks** of real trips (14ers.com · ListsofJohn · peakbagger · Kyle's recordings) — all layered on the [interactive CalTopo research map](https://caltopo.com/m/KQCQ1L6).*
<!-- PROVENANCE_END -->
*[Interactive CalTopo map](https://caltopo.com/m/KQCQ1L6)* — 8 source GPX tracks (LoJ + 14ers library) + Kyle's Huerfano-basin tracks, layered by source.
