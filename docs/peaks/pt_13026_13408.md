...
| | [PT 13,408](https://www.14ers.com/peaks/10421) | [PT 13,026](https://www.14ers.com/peaks/10602) |
|---|---|---|
...
| **Recommended loop** | A true loop from the Eddiesville TH: up the eastern approach to PT 13,408, NW over to PT 13,026, then **down the middle/west corridor** — each peak once, **no re-climb** |
...
*The **recommended route (bold magenta)** — a clean **loop** through PT 13,408 + PT 13,026 from the Eddiesville TH: up the eastern approach to PT 13,408, over to PT 13,026, and **down a separate corridor** back to the TH — it tags each peak once and never re-climbs 13,026. Drawn over all the source tracks (green), which sprawl off to San Luis, Stewart, Organ, and Phoenix.*
