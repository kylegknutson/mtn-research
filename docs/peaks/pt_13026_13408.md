...
yds_class: "2"
gain: "~16 mi / ~5,000 ft (recommended loop, Eddiesville TH, DEM)"
status: unclimbed
caltopo_id: 562G87A
...
| **Recommended loop (composed)** | **~16 mi / ~5,000'** — a true loop from the Eddiesville TH: up the eastern approach to PT 13,408, NW over to PT 13,026, then **down the middle/west corridor** — each peak once, **no re-climb**. Taken from a real recorded loop (`build_recommended_route.py`); gain DEM-measured |
...
*The **recommended route (bold magenta)** — a clean **loop** through PT 13,408 + PT 13,026 from the Eddiesville TH, **~16 mi / ~5,000'**, taken from a real recorded loop: up the eastern approach to PT 13,408, over to PT 13,026, and **down a separate corridor** back to the TH — it tags each peak once and never re-climbs 13,026. Drawn over all the source tracks (green), which sprawl off to San Luis, Stewart, Organ, and Phoenix.*
...
- **climb13ers.com:** [UN 13,026 "East Flank–NE Ridge"](https://www.climb13ers.com/colorado-13ers/un13015) — **13.5 mi / 2,655'** (an estimate; the recorded-GPX clean loop is ~16 mi / ~5,000' DEM — both climb13ers figures run low; see the recommended-day note).
...
- **Two ranked La Garita 13ers (Class 2)** ~1.4 mi apart — sequenced as one day from the **Cochetopa Creek / Eddiesville TH (north)**: **~16 mi / ~5,000'** (recorded-GPX clean loop, DEM gain; climb13ers estimates 13.5 mi / 2,655', which runs low), a long valley approach (CDT/Colorado Trail) + easy Class 2, with beetle-kill deadfall.
