---
image: maps/west_willow_la_garita.png
range: San Juan
drive_time: "~5 h to Creede + rough 4WD"
yds_class: "3"
gain: "~24 mi / ~7,800 ft over 2 days · ~25 mi / ~8,400 ft if linked in one push"
status: unclimbed
...
> Consolidates two day-reports that **launch from the same West Willow Creek upper TH** above Creede: the **[Baldy Lejos trio](../peaks/baldy_lejos_trio.md)** (Baldy Lejos + PT 13,115 + PT 13,030) and the **[PT 13,308 + PT 13,166 bridge pair](../peaks/pt_13308_13166.md)**. One trailhead, one camp — two ~12-mile day-loops, or one big push. (The eastern [PT 13,408 + 13,026 pair](../peaks/pt_13026_13408.md) is *not* part of this — it's a separate Cochetopa/Eddiesville trailhead, a different drive.)
...
| **Day — trio** | Baldy Lejos + PT 13,115 + PT 13,030 — **~12 mi / ~3,600'** (DEM) |
| **Day — bridge pair** | PT 13,308 + PT 13,166 — **~11.8 mi / ~4,200'** (DEM) |
| **2-day total** | **~24 mi / ~7,800'** |
| **Big-day option (all 5)** | **~25 mi / ~8,400'** — strong parties only (see below) |
...
All five share the **West Willow Creek upper TH** (~11,500', up the rough road from Creede). They fall into **two natural loops that only meet along the high divide**:

- **The trio** (Baldy Lejos, PT 13,115, PT 13,030) sits **NW** of the TH — a ~12 mi Class 2 tundra loop.
- **The bridge pair** (PT 13,308, PT 13,166) sits **E/SE** of the TH — a ~11.8 mi loop with a **Class 3** move on PT 13,166.
...
> **Doing all five in one push is ~25 mi / ~8,400'** — barely shorter than the two days combined, because the trio and the pair only connect along the divide (linking them adds traverse miles without saving a trailhead return). It's a legitimate ultra-day for a very strong party, but the **2-day split is the sane recommendation**.

---

## Day plan

### Trio day — Baldy Lejos + PT 13,115 + PT 13,030 · ~12 mi / ~3,600' · Class 2
...
### Bridge-pair day — PT 13,308 + PT 13,166 · ~11.8 mi / ~4,200' · Class 2 (Class 3 on 13,166)
...
- **Five ranked La Garita 13ers from one West Willow upper TH**, best as a **2-day backpack** (~24 mi / ~7,800'): a Class 2 trio day NW + a Class 2/3 pair day E/SE, camping high near San Luis Pass.
- **All five in a day is ~25 mi / ~8,400'** — strong parties only; the two loops only meet on the divide, so linking them barely saves distance.
